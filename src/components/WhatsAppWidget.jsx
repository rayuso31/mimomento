...
const WhatsAppWidget = () => {
    ...
    return (
        <motion.a
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-8 right-8 bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-lg z-40 cursor-pointer hover:shadow-xl transition-shadow"
        >
